...
/* 3 */ KC_TAB,   KC_A, KC_S, KC_D, KC_F, KC_G,           /* SPLIT */           KC_H,                                             KC_J, KC_K, KC_L, KC_SCLN,  KC_QUOT, /* # */
/* 4 */ KC_BSLS,  LCTL_T(KC_Z),         LSFT_T(KC_X),         LGUI_T(KC_C),         LALT_T(KC_V),         KC_B,   KC_MUTE,  /* SPLIT */ KC_MUTE,  KC_N, RALT_T(KC_M),         RGUI_T(KC_COMM),      RSFT_T(KC_DOT),       RCTL_T(KC_SLSH),          KC_TILD, /* # */
