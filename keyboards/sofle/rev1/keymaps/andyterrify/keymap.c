...
[_BASE] = LAYOUT_some(
  ...
  // |---------------+----------------+----------------+----------------+----------------+----------------|  MUTE |
          KC_BSLS,      LCTL_T(KC_Z),    LSFT_T(KC_X),    LGUI_T(KC_C),    LALT_T(KC_V),      KC_B,     //|-------|
  // `---------------+----------------+----------------+----------------+----------------+----------------/       /
        QK_BOOT,         XXXXXXX,          OSL(_LOWER),    MO(_LOWER),       KC_SPC,          KC_MUTE,
  //           `------------------------------------/
  ...
  // |---------------+----------------+----------------+----------------+----------------+----------------|  MUTE |
          KC_N,        RALT_T(KC_M),   RGUI_T(KC_COMM), RSFT_T(KC_DOT),  RCTL_T(KC_SLSH),     KC_TILD,  //|-------|
  // `---------------+----------------+----------------+----------------+----------------+----------------/       /
        KC_MUTE,         KC_ENT,          MO(_RAISE),    OSL(_RAISE),       XXXXXXX,          QK_BOOT
  //           `------------------------------------/
),
...
[_GAME] = LAYOUT_some(
  ...
  KC_LCTL,    KC_Z,           KC_X,           KC_C,           KC_V,           KC_B,
        XXXXXXX, MO(_RAISE), KC_LALT, OSL(_GAME_NUMBER),   KC_SPC, KC_MUTE,
...
[_GAME_NUMBER] = LAYOUT_some(
  ...
  QK_GESC,    KC_F1,      KC_F2,      KC_F3,      KC_F4,      KC_F5,
